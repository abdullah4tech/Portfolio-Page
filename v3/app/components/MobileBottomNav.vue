...
const links = [
  ...
  },
  {
    ...
    activeIcon: "solar:gallery-wide-bold-duotone",
  },
];
...
.mob-nav__bar {
  ...
  box-shadow: 0 0 0 0.5px rgba(0, 0, 0, 0.03), 0 8px 24px rgba(0, 0, 0, 0.08),
...
:global(.dark) .mob-nav__item {
  color: rgba(255, 255, 255, 0.3);
}

:global(.dark) .mob-nav__item--active {
